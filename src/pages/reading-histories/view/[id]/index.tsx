...
import { getReadingHistoryById } from 'apiSdk/reading-histories';
import { ReadingHistoryInterface } from 'interfaces/reading-history';

function ReadingHistoryViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('reading_history', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/reading-histories/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  label="Date Read"
                  text={data?.date_read ? format(parseISO(data?.date_read as unknown as string), 'dd-MM-yyyy') : ''}
                />
