...
import { getContentEngagementById } from 'apiSdk/content-engagements';
import { ContentEngagementInterface } from 'interfaces/content-engagement';

function ContentEngagementViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Content Engagement Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('content_engagement', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/content-engagements/edit/${id}`} passHref legacyBehavior>
                    <Button
                ...
                <FormListItem
                  ...
                  text={
                    data?.engagement_date
                      ? format(parseISO(data?.engagement_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Engagement Type" text={data?.engagement_type} />
