...
export function BookListPage(props: BookListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBooks({
        relations: [, 'reading_history.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['title.contains', 'author.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('reading_history', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'reading_history',
          header: 'Reading History',
          accessorKey: 'reading_history',
          cell: ({ row: { original: record } }: any) => record?._count?.reading_history,
        }
      : null,
